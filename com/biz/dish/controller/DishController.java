package com.biz.dish.controller;
...
import com.biz.dish.domain.Dish;
import com.biz.dish.service.DishService;
import com.biz.dish.vo.DishVO;
import com.fairyland.ext.mybatis.Page;

/**
 *@description 菜谱 --控制器
 *@Author：wangyanfei
 *@Date:2017-04-14 13:55:04
 */
@Controller
...
public class DishController {
	...
	public ModelAndView data(Dish vo,Page<HashMap<String, Object>> page){
		...
		return new ModelAndView("zjxm/dish/dishData")
				.addObject("page", page);
	}
	...
	public ModelAndView toAdd(){
		return new ModelAndView("zjxm/dish/dishAdd")
	...
	public ModelAndView toView(Long id){
		...
		return new ModelAndView("zjxm/dish/dishView")
